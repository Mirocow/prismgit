...
| **4** ⏳ | UI-настройки: Low-level таблица (4.1), double-click, welcome, даты, case (4.3–4.7) — **4.2 ✅ тема Auto** | P1 | 5–8 дн | частично 0.x |
...
> Статус: ✅ фазы 0, 1, 2, 4.5 и 4.2 реализованы (коммиты `8132d74`, `506c093`, `4f44c4b`; детали — раздел 7 `docs/dead-code-report.md`). Следующие по порядку: 4.1 (Low-level таблица) → 3 → 5 (5.2 secrets — приоритет при распространении наружу) → 6.
